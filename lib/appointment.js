...
class AppointmentMongoDB {
    ...
    getByContainer (params) {
        return new Promise((resolve, reject) => {
            ...
            if ( (params.email === undefined || params.email === '') && params._id === undefined) {
                reject({status: 'ERROR', data: 'Debe proveer el dato del email para obtener el/los turnos.'});
            } else {
                if (params.contenedor) {
    ...
    getByPatente (params) {
        return new Promise((resolve, reject) => {
            ...
            var param = {
                patenteCamion: params.patente.toUpperCase(),
