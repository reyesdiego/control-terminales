                ...
                pool.getConnection(function (err, connection) {
                    if (err) {
                        ...
                        strSql = "SELECT * " +
                            ...
                            "    RSI.MEDIDA MEDIDA_I " +
                            "FROM gates " +
                            "   LEFT JOIN REGISTRO4_SUMEXPOMANE RSE ON gates.CONTENEDOR = RSE.CONTENEDOR AND gates.MOV = 'EXPO' " +
                            "   LEFT JOIN REGISTRO4_SUMIMPOMANI RSI ON gates.CONTENEDOR = RSI.CONTENEDOR AND gates.MOV = 'IMPO' " +
                            " %s ) " +
            ...
            pool.getConnection(function (err, connection) {
                if (err) {
                    ...
                    strSql = "insert into GATES " +
                        ...
                        ":patenteCamion, :tren, to_date(:registrado_en, 'YYYY-MM-DD HH24:MI:SS') ) RETURNING ID INTO :outputId";
                    values = {
