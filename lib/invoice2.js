                        ...
                        const strSql = `SELECT *
                                        FROM (
                                            ...
                                            FROM V_INVOICE_HEADER_DETAIL I
                                                INNER JOIN TARIFARIO_TERMINAL TT ON I.CODE = TT.CODE AND
                                                                                    I.TERMINAL = TT.TERMINAL
                                                INNER JOIN TARIFARIO T ON T.ID = TT.TARIFARIO_ID
                                            WHERE FECHA_EMISION >= TO_DATE('2017-12-01', 'YYYY-MM-DD') AND
                                                FECHA_EMISION <= TO_DATE('2017-12-01', 'YYYY-MM-DD')
