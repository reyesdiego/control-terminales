...
class PriceOracle {
    ...
    getHeadersGroups (tarifario_header_id) {
        return new Promise((resolve, reject) => {
            ...
            if (pool) {
                ...
                console.log(tarifario_header_id);
                pool.getConnection ((err, connection) => {
    ...
    getPrice (id) {
        return new Promise((resolve, reject) => {
            ...
            if (pool) {
                pool.getConnection((err, connection) => {
                    strSql = `SELECT T.ID, TERMINAL, CODE, DESCRIPCION, UNIDAD, RATE, FECHA, PRECIO, MONEDA, LARGO, NORMA, MOV
                        FROM TARIFARIO T
    ...
    getPrices (params) {
        return new Promise((resolve, reject) => {
            ...
            if (pool) {
                strSql = "SELECT TPP.PRECIO, TPP.MONEDA, T.CODE, T.DESCRIPCION, T.ID, T.TERMINAL, TP.FECHA, T.UNIDAD, T.RATE, T.LARGO, T.NORMA, T.MOV " +
                    "FROM TARIFARIO T " +
