	...
	if (username !== undefined && username !== '' && password !== undefined && password !== ''){
		this.findOne({email: username, password: password}, function(err, user){
			if (err){
				...
				var rutasAcceso = ['matches.search','tarifario', 'invoices', 'invoices.result', 'invoices.search', 'matches', 'control', 'cfacturas', 'cfacturas.result', 'gates', 'gates.result', 'gates.result.container', 'gates.result.invoices', 'gates.result.invoices.result', 'turnos', 'turnos.result'];
