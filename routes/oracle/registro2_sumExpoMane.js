...
module.exports = function (log, oracle) {
    ...
    function getTransbordos(req, res) {
        ...
        transbordos(req, function (err, data) {
            ...
            if (err) {
                ...
                strSql = "SELECT COUNT(*) AS TOTAL FROM V_TRANSBORDO_EXPO ";
                if (strWhere !== '') {
                    strSql += util.format(" %s", strWhere);
                }
    ...
    router.get('/transbordosExpo/:skip/:limit', getTransbordos);
    router.get('/transbordoExpo', getTransbordo);
